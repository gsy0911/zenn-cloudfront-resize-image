...
export class AssetsNodeLambdaEdgeStack extends Stack {
  ...
  constructor(scope: Construct, id: string, params: IAssetsLambdaEdgeStack, props?: StackProps) {
    ...
    const edgeViewerRequest = new aws_lambda.Function(this, "edge-viewer-request", {
      ...
      functionName: `image-viewer-request`,
    ...
    new aws_lambda.Alias(this, "cf-alias-viewer-request", {
      aliasName: 'latest',
      version: edgeViewerRequest.currentVersion,
    })
    new XRegionParam(this, "x-region-param-viewer-request", {
      region: "ap-northeast-1"
    }).putSsmParameter({
      parameterName: `/${prefix}/assets-stack/lambda-edge/node/viewer-request`,
      parameterValue: `${edgeViewerRequest.functionArn}:${edgeViewerRequest.currentVersion.version}`,
      parameterDataType: "text",
      idName: `x-region-param-id`
    })
    ...
    const edgeOriginResponse = new aws_lambda.Function(this, "edge-origin-response", {
      ...
      functionName: `image-origin-response`,
    ...
    new aws_lambda.Alias(this, "cf-alias-origin-response", {
      aliasName: 'latest',
      version: edgeOriginResponse.currentVersion,
    })
    new XRegionParam(this, "x-region-param-origin-response", {
      region: "ap-northeast-1"
    }).putSsmParameter({
      parameterName: `/${prefix}/assets-stack/lambda-edge/node/origin-response`,
      parameterValue: `${edgeOriginResponse.functionArn}:${edgeOriginResponse.currentVersion.version}`,
      parameterDataType: "text",
      idName: `x-region-param-id`
    })
  }
